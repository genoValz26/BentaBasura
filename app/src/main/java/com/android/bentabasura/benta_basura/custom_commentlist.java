...
public class custom_commentlist extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ImageView imgThumbTrash = (ImageView) rowData.findViewById(R.id.imgPic);
        ...
        Picasso.with(ctx).load(comments .get(position).getProfileImage()).placeholder(R.drawable.progress_animation).transform(new RoundedTransformation(100, 20)).fit().into(imgThumbTrash);
