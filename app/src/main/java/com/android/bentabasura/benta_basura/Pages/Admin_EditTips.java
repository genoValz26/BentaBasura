...
public class Admin_EditTips extends Admin_Navigation
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final View contentView = inflater.inflate(R.layout.activity_edit_tips, null, false);
        ...
        deletebtn = (Button) contentView.findViewById(R.id.deletbtn);

        receiveIntent = getIntent();
        receivedBundle = receiveIntent.getExtras();

        tipsTitleTxt.setText(receivedBundle.get("TipsTitle").toString());
        tipsContentTxt.setText(receivedBundle.get("TipsDetail").toString());
        Picasso.with(getApplicationContext()).load(receivedBundle.get("TipsImagePath").toString()).placeholder(R.drawable.progress_animation).fit().into(imageView);
    ...
    private void addTips(){
        ...
        if (picUri == null || Uri.EMPTY.equals(picUri))
        {
                    ...
                    Tips newTips = new Tips(tipsTitleTxt.getText().toString(), tipsContentTxt.getText().toString(), receivedBundle.get("TipsDate").toString(), receivedBundle.get("TipsImagePath").toString());
                    databaseReference.child("Tips").child(receivedBundle.get("TipsID").toString()).setValue(newTips);
                    showMessage("Tip Updated Successfully");
        ...
        else
        {
            ...
            path.putFile(picUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Tips newTips = new Tips(tipsTitleTxt.getText().toString(), tipsContentTxt.getText().toString(), receivedBundle.get("TipsDate").toString(), taskSnapshot.getDownloadUrl().toString());
                    databaseReference.child("Tips").child(receivedBundle.get("TipsID").toString()).setValue(newTips);
                    showMessage("Tip Updated Successfully");
                    progressDialog.dismiss();
                    startActivity(new Intent(getApplicationContext(), Admin_ManageTips.class));
    ...
    public AlertDialog.Builder buildDeleteDialog(Context c) {
        ...
        builder.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                databaseReference.child("Tips").child(receivedBundle.get("TipsID").toString()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        showMessage("Tip has been removed!");
                        startActivity(new Intent(getApplicationContext(), Admin_ManageTips.class));
                        finishAndRemoveTask();
                    }
                });
