...
public class Cart extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilePage = new Intent(Cart.this, MyProfile.class);
        buyCrafted = new Intent(Cart.this, BuyCrafted.class);
        buyRaw = new Intent(Cart.this, BuyRaw.class);
        sellCrafted = new Intent(Cart.this, SellCrafted.class);
        sellRaw = new Intent(Cart.this, SellRaw.class);
