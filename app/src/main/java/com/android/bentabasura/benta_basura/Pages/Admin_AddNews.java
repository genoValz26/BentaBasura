...
public class Admin_AddNews extends Admin_Navigation
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        View contentView = inflater.inflate(R.layout.activity_news_template, null, false);
    ...
    private void addNews(){
        ...
        path.putFile(picUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                News addNews = new News(newsTitleTxt.getText().toString(),newsContentTxt.getText().toString(),UploadedDate, taskSnapshot.getDownloadUrl().toString());
                databaseReference.child("News").push().setValue(addNews);
                showMessage("News Uploaded Successfully");
