...
import com.android.bentabasura.benta_basura.Page_Adapters.PageAdapterBoughtItems;
...
public class BoughtItems extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final PagerAdapter adapter = new PageAdapterBoughtItems(getSupportFragmentManager(), tabLayout.getTabCount());
